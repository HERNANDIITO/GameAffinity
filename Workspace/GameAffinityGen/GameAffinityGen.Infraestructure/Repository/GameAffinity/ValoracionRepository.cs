    ...
    public partial class ValoracionRepository : BasicRepository, IValoracionRepository
    {
        ...
        public int New_(ValoracionEN valoracion)
        {
            ...
            try
            {
                ...
                {
                    // Argumento OID y no colección.
                    valoracionNH.Videojuego_valorado = (GameAffinityGen.ApplicationCore.EN.GameAffinity.VideojuegoEN)session.Load(typeof(GameAffinityGen.ApplicationCore.EN.GameAffinity.VideojuegoEN), valoracion.Videojuego_valorado);
                }
